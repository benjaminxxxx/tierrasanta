...
class KardexAlmacenSheetExport implements FromCollection, WithHeadings, WithMapping, WithStyles, ShouldAutoSize, WithTitle
{
    protected $productoId = '';
    protected $sheetName = '';
    public function __construct($productoId,$sheetName){
