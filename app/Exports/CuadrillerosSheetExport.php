...
class CuadrillerosSheetExport implements FromCollection, WithHeadings, WithMapping, WithStyles, ShouldAutoSize, WithTitle
{
    ...
    {
        return Cuadrillero::orderBy('codigo_grupo','desc')
