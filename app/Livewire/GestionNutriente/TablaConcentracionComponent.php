...
class TablaConcentracionComponent extends Component
{
    ...
    public function mount()
    {
        ...
        $this->listaFertilizantes = Producto::where('categoria_codigo', 'fertilizante')->pluck('nombre_comercial')->toArray();
    ...
    {
        return view('livewire.gestion-nutriente.tabla-concentracion-component');
    }
}
