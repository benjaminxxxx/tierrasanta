    ...
    theme: {
        ...
        extend: {
          ...
          colors: {
            ...
            'meta-8': '#F0950C',      // Sin cambio, naranja para notificaciones
            'meta-9': '#E5E7EB',      // Sin cambio, gris suave
            success: '#219653',       // Color verde derivado del primary para éxito
            danger: '#D34053',        // Sin cambio, rojo para peligro
            warning: '#FFA70B',       // Sin cambio, amarillo para advertencias
          },
          fontSize: {
            'title-xxl': ['44px', '55px'],
            'title-xl': ['36px', '45px'],
