...
@props([
    'noScroll' => false, // false = comportamiento normal con scroll interno
])

<div
    {{ $attributes->merge([
        'class' => $noScroll
            ? 'relative rounded-lg border border-border bg-background backdrop-blur-sm'
            : 'relative overflow-x-auto rounded-lg border border-border bg-background backdrop-blur-sm',
    ]) }}>
