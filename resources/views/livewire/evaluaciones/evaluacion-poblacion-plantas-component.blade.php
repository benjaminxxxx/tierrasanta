<div class="space-y-4">
    <x-flex>
        ...
        @can(\App\Constants\Permisos::PLANTA_EVALUACION_CREAR)
    ...
    <x-card class="my-4">
        <x-flex class="justify-between">
            ...
            @can(\App\Constants\Permisos::PLANTA_EVALUACION_REPORTE)
                <div class="relative">
                    <x-dropdown width="60">
                        <x-slot name="trigger">
    ...
    @can(\App\Constants\Permisos::PLANTA_EVALUACION_VER)
                        ...
                        <tr class="border-b border-border">
                            ...
                            <x-td class="text-center">
                                <x-flex class="justify-center gap-2">
                                    ...
                                    @can(\App\Constants\Permisos::PLANTA_EVALUACION_EDITAR)
                                    ...
                                    @can(\App\Constants\Permisos::PLANTA_EVALUACION_ELIMINAR)
