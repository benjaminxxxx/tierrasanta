<div class="space-y-4" x-data="tabla_concentraciones">
    <div>
        <x-title>
    ...
    <x-card>
        @can(\App\Constants\Permisos::INSUMO_CONCENTRACION_VER)
            <div wire:ignore>
    ...
    <x-inferior-derecha>
        @can(\App\Constants\Permisos::INSUMO_CONCENTRACION_GESTIONAR)
