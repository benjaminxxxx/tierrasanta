<div>
    <div class="md:flex gap-5">
        <div class="flex-1 space-y-4">
            <div>
                <x-title>Descuentos de AFP y el Sistema Nacional de Pensiones</x-title>
            </div>
            <x-card>
                @can(\App\Constants\Permisos::PLANILLA_CONFIG_AFP_GESTIONAR)
                    <div class="mt-6">
                ...
                @endcan
                @can(\App\Constants\Permisos::PLANILLA_CONFIG_AFP_VER)
                    <x-table class="mt-6">
                        <x-slot name="thead">
