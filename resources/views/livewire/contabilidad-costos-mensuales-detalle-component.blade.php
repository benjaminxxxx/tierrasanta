                        ...
                        @foreach ($campos as $campo)
                            <x-tr>
                                ...
                                <x-td class="text-center">
                                    ...
                                    @if ($campo['warning'])
                                        <i class="fa-solid fa-triangle-exclamation text-yellow-500 ml-2"
                                            title="Advertencia"></i>
                                    @endif
                                </x-td>
        ...
        <div class="flex-1">
            ...
            <x-card class="my-5">
                <x-flex class="w-full justify-end gap-3">
                    ...
                    @can(\App\Constants\Permisos::CONTABILIDAD_COSTO_MENSUAL_GESTIONAR)
                        @if ($modoEdicion)
                            <x-button variant="secondary" type="button" wire:click="cancelarEdicion">
                                Cancelar
                            </x-button>
                        ...
                        @else
                            ...
                            @if ($costoMensualId)
                                <x-button type="button"
                                    @click="$wire.dispatch('distribuirCostosMensuales',{costoMensualId:{{ $costoMensualId }}})">
