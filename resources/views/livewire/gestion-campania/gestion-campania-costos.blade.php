<div class="space-y-4">
    <x-flex class="justify-between">
        ...
        <x-flex>
            <x-select label="Seleccionar campo" wire:model.live="campoSeleccionado" class="w-auto">
                            ...
                            <x-tr>
                                ...
                                @foreach ($campanias as $campaniaTh)
                                    <x-th class="text-center bg-gray-700 min-w-[200px]">
                                        ...
                                        {{ $campaniaTh['nombre_campania'] }}
                                        @can(\App\Constants\Permisos::CAMPAÑA_COSTOS_GESTIONAR)<br />
                                            <x-button wire:click="detectarCostos({{ $campaniaTh['id'] }})">Detectar <i
                                                    class="fa fa-sync"></i></x-button>
                                        @endcan
                                    </x-th>
                                @endforeach
                            </x-tr>
