...
<x-tr>
    ...
    <x-td class="text-right">{{ $campania->infestacion_duracion_desde_campania }}</x-td>
</x-tr>
<x-tr>
...
<x-tr>
    ...
    <x-td class="text-right">{{ number_format($campania->infestacion_kg_totales_madre, 0) }}</x-td>
</x-tr>
<x-tr>
    <x-td>Kg de madres para infestador cartón</x-td>
    <x-td class="text-right">{{ number_format($campania->infestacion_kg_madre_infestador_carton, 0) }}</x-td>
</x-tr>
<x-tr>
    <x-td>Kg de madres para infestador tubos</x-td>
    <x-td class="text-right">{{ number_format($campania->infestacion_kg_madre_infestador_tubos, 0) }}</x-td>
</x-tr>
<x-tr>
    <x-td>Kg de madres para infestador mallita</x-td>
    <x-td class="text-right">{{ number_format($campania->infestacion_kg_madre_infestador_mallita, 0) }}</x-td>
</x-tr>
<x-tr>
...
<x-tr>
    ...
    <x-td class="text-right">{{ $campania->infestacion_cantidad_madres_por_infestador_carton_alias }}</x-td>
</x-tr>
<x-tr>
    <x-td>Cantidad de madres por infestador tubo</x-td>
    <x-td class="text-right">{{ $campania->infestacion_cantidad_madres_por_infestador_tubos_alias }}</x-td>
</x-tr>
<x-tr>
    <x-td>Cantidad de madres por infestador mallita</x-td>
    <x-td class="text-right">{{ $campania->infestacion_cantidad_madres_por_infestador_mallita_alias }}</x-td>
</x-tr>
<x-tr>
    <x-td>Cantidad de infestadores cartón</x-td>
    <x-td class="text-right">{{ number_format($campania->infestacion_cantidad_infestadores_carton, 0) }}</x-td>
</x-tr>
<x-tr>
    <x-td>Cantidad de infestadores tubos</x-td>
    <x-td class="text-right">{{ number_format($campania->infestacion_cantidad_infestadores_tubos, 0) }}</x-td>
</x-tr>

<x-tr>
    <x-td>Cantidad de infestadores mallita</x-td>
    <x-td class="text-right">{{ number_format($campania->infestacion_cantidad_infestadores_mallita, 0) }}</x-td>
</x-tr>
<x-tr>
...
<x-tr>
    ...
    <x-td class="text-right">{{ $campania->infestacion_permanencia_infestadores }}</x-td>
</x-tr>
<x-tr>
