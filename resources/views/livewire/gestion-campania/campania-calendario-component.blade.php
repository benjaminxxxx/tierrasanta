        ...
        &&
            ...
            ">
                ...
                <div class="flex flex-col space-y-4">
                    <!-- contenido del campo -->
                    <h2 class="text-2xl font-bold text-card-foreground px-2 tracking-tight">
                        {{ $campo['nombre'] }}
                    </h2>
                    ...
                    <div class="flex overflow-x-auto pb-4 gap-4">
                        @forelse ($campo['campanias'] as $campania)
                            ...
                            <div class="flex-none w-[200px] group">
                                <div
                                    class="relative h-full flex flex-col bg-muted border border-border rounded-xl p-4 shadow-sm hover:shadow-md transition-all border-l-4 {{ $esActiva ? 'border-l-green-500' : 'border-l-blue-500' }}">
