    ...
    <x-dialog-modal wire:model.live="mostrarFormulario">
        ...
        <x-slot name="content">
            ...
            <div x-data="{{ $idTable }}" wire:ignore class="my-4">
                <div x-ref="tableContainerFiltrado" ></div>
            </div>
    ...
    <script>
        Alpine.data('{{ $idTable }}', () => ({
            ...
            init() {
                this.initTable();
                this.listeners.push(
                    Livewire.on('cargarDataFiltrado', (data) => {
                ...
                this.listeners.push(
                    ...
                    Livewire.on('guardadoConfirmadoFiltrado', () => {
                        this.senDataCochinillaFiltrado();
                    })
                );
            },
            initTable() {
                const container = this.$refs.tableContainerFiltrado;
            ...
            senDataCochinillaFiltrado() {
                ...
                $wire.dispatchSelf('storeTableDataCochinillaIngresoFiltrado', data);
            }
        }));
    </script>
@endscript
