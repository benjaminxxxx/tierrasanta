<div>
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
            <x-stats-card title="Planilla Agraria" :value="$estadisticas['total_empleados_agraria']['valor'] ?? 0"
                icon="fa-users" description="Empleados activos en la empresa"
                :trend="$this->calcularTrend('total_empleados_agraria')" trendLabel="vs mes anterior" />
            <x-stats-card title="Planilla Oficina" :value="$estadisticas['total_empleados_oficina']['valor'] ?? 0"
                icon="fa-users" description="Empleados activos en la empresa"
                :trend="$this->calcularTrend('total_empleados_oficina')" trendLabel="vs mes anterior" />
